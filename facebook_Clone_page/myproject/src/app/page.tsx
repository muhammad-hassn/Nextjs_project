...
<section className="flex mt-48 mx-auto items-center justify-center ">
<div className=" w-1/3 pr-10 mr-10">
<div className=" w-[50vh] ">
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 1090 360">
...
<p className="text-3xl ml-6  mt-0">Facebook helps you connect and share with the people in your life.
</p>
</div>
